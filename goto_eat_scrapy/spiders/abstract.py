    ...
    def __init__(self, logfile=None, *args, **kwargs):
        ...
        if logfile:
            ...
            self.logzero_logger = logzero.setup_logger(
                name=logger_name, logfile=logfile, fileLoglevel=logging.DEBUG, disableStderrLogger=True
            )
        else:
            ...
            # 標準出力に出す
            self.logzero_logger = logzero.setup_logger(name=logger_name, level=logging.INFO)
